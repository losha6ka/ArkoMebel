$(document).ready(function () {
	...
	$.each($('.cart-accept__radio-item'), function (index, val) {
		if ($(this).find('input').prop('checked') == true) {
			$(this).addClass('active')
		}
	});
	$(document).on('click', '.cart-accept__radio-item', function (event) {
		$(this).parents('.cart-accept__radio').find('.cart-accept__radio-item').removeClass('active');
		$(this).parents('.cart-accept__radio').find('.cart-accept__radio-item input').prop('checked', false);
		$(this).toggleClass('active');
		$(this).find('input').prop('checked', true);
		return false;
	});
